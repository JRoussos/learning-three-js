...
const ColorSwift = ({ setPage, page, numberOfPages }) => {
    ...
    useFrame( () => {
      ...
      // mesh.current.material.uniforms.resolution.value = uResolution
    })
  
    return(
      <>
      <mesh ref={mesh} position={[5, 0, 0]} onClick={() => setPage( numberOfPages > page ? page+1 : 0 )}>
      ...
      <Html fullscreen position={[5, 0, 0.2]}>
